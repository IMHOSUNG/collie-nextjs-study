            ...
            <form className="flex basis-10/12" onSubmit={(e) => handleSubmit(e)} >
                ...
                <div tabIndex={1} onKeyDown={handleKeyDown} className="relative w-full m-4">
                    <div ref={SearchBarRef}>
                        ...
                        <input value={defaultValue?.name} onChange={handleChange} className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
                        ...
                        {showResults && (
                            <>
                                ...
                                <div className="absolute mt-56 bg-gray-300 w-full">
                                    <Link href="/post">
